 ...
 * 
 * 6.Add more functionalities to paciente and doctor. For example, add a history of illnesses to the patient, create an appointment to the patient. 
 *
 */
public class Main {
     /**
     ...
     */
    private static void showMenuPersona() {
        boolean running = true;
        while (running) {
     ...
     */
    private static void showMenuPacienteProtectRegistrado() {
        boolean running = true;
        while (running) {
     ...
     */
    private static void showMenuPaciente() {
        boolean running = true;
        while (running) {
    ...
    private static void showMenuDoctorGeneral() {
        boolean running = true;
        while (running) {
    ...
    private static void showMenuDoctorProtectRegistrado() {
        boolean running = true;
        while (running) {
            System.out.println("Precione un numero: ");
            System.out.println("1. Tengo un ID: ");
     ...
     * Muestra el menú para Paciente todo paciente.
     */
    private static void showMenuDoctor() {
        boolean running = true;
        while (running) {
     ...
     */
    private static boolean buscarPaciente() {
     ...
     */
    private static boolean buscarDoctor() {
     ...
     */
    private static boolean verifyAdminPassword() {
